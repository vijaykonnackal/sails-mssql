...
module.exports = require('machine').build({
  ...
  fn: function registerDataStore(inputs, exits) {
    ...
    Helpers.connection.createManager(inputs.config.url, inputs.config, function (e, report) {
      if (e) {
